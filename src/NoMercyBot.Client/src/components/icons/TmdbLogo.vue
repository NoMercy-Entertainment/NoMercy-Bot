<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 190.24 81.52" class="h-auto w-12">
    <defs>
      <linearGradient id="linear-gradient" x2="190.24" y1="40.76" y2="40.76" gradientUnits="userSpaceOnUse">
    ...
    <g id="Layer_2" data-name="Layer 2">
      <path id="Layer_1-2"
            ...
            data-name="Layer 1" style="fill: url('#linear-gradient');"
      />
    </g>
  </svg>
</template>
