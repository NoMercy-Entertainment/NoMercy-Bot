...
public class ChatEmote
{
    ...
    [JsonProperty("owner_id", NullValueHandling = NullValueHandling.Ignore)] public string OwnerId { get; set; } = string.Empty;
    ...
    [JsonProperty("urls", NullValueHandling = NullValueHandling.Ignore)] public Dictionary<string, Uri> Urls { get; set; }
