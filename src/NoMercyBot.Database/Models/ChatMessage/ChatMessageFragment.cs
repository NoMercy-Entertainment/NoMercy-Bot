...
{
    [JsonProperty("type", NullValueHandling = NullValueHandling.Ignore)] public string Type { get; set; } = string.Empty;
    [JsonProperty("text", NullValueHandling = NullValueHandling.Ignore)] public string Text { get; set; } = string.Empty;
    [JsonProperty("cheermote", NullValueHandling = NullValueHandling.Ignore)] public ChatCheermote? Cheermote { get; set; }
