...
namespace NoMercyBot.Database.Migrations
{
    ...
    [Migration("20250719230029_Init21")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NoMercyBot.Database.Models.ChatMessage.ChatCheermote", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("NoMercyBot.Database.Models.ChatMessage.ChatMention", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("NoMercyBot.Database.Models.ChatMessage.ChatMessage", b =>
                {
                    ...
                    b.Property<string>("MessageNode_id")
                        .HasMaxLength(256)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("NoMercyBot.Database.Models.ChatMessage.ChatMessageFragment", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");

                    b.Property<string>("CheermoteId")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("HtmlPreviewCustomContent")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("CheermoteId");

                    b.HasIndex("EmoteId");

                    b.HasIndex("MentionId");

                    b.ToTable("ChatMessageFragment");
                });

            modelBuilder.Entity("NoMercyBot.Database.Models.ChatMessage.MessageNode", b =>
                {
            ...
            modelBuilder.Entity("NoMercyBot.Database.Models.ChatMessage.ChatMessage", b =>
                {
                    ...
                    b.HasOne("NoMercyBot.Database.Models.ChatMessage.MessageNode", "MessageNode")
                        .WithMany()
                        .HasForeignKey("MessageNode_id")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("NoMercyBot.Database.Models.ChatMessage.ChatMessageFragment", b =>
                {
                    b.HasOne("NoMercyBot.Database.Models.ChatMessage.ChatCheermote", "Cheermote")
                        .WithMany()
                        .HasForeignKey("CheermoteId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("NoMercyBot.Database.Models.ChatMessage.ChatEmote", "Emote")
                        .WithMany()
                        .HasForeignKey("EmoteId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("NoMercyBot.Database.Models.ChatMessage.ChatMention", "Mention")
                        .WithMany()
                        .HasForeignKey("MentionId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.Navigation("Cheermote");
            ...
            modelBuilder.Entity("NoMercyBot.Database.Models.ChatMessage.MessageNode", b =>
                {
                    b.HasOne("NoMercyBot.Database.Models.ChatMessage.MessageNode", null)
                        .WithMany("Children")
                        .HasForeignKey("MessageNode_id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
