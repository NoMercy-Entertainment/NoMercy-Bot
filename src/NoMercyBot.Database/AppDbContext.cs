...
public class AppDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        optionsBuilder.UseSqlite(
            $"Data Source={AppFiles.DatabaseFile}; Pooling=True",
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder
            ...
            .HasConversion(
                v => JsonConvert.SerializeObject(v),
                v =>
                    JsonConvert.DeserializeObject<List<ChatMessageFragment>>(v)
                    ?? new List<ChatMessageFragment>()
            );
        ...
        modelBuilder
            ...
            .HasConversion(
                v => JsonConvert.SerializeObject(v),
                v =>
                    JsonConvert.DeserializeObject<Dictionary<string, Uri>>(v)
