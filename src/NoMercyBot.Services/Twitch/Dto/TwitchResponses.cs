...
{
    [JsonProperty("data")] public List<StreamInfo> Data { get; set; } = [];
    [JsonProperty("pagination")] public Dictionary<string, string> Pagination { get; set; } = new();
}
...
public class StreamInfo
{
    ...
    [JsonProperty("thumbnail_url")] public string ThumbnailUrl { get; set; } = string.Empty;
