...
{
    [JsonProperty("channelEmotes")] public BttvEmote[] ChannelEmotes { get; set; } = [];
    [JsonProperty("sharedEmotes")] public BttvEmote[] SharedEmotes { get; set; } = [];
}
...
public class BttvEmote
{
    ...
    [JsonProperty("imageType")] public string ImageType { get; set; } = string.Empty;
