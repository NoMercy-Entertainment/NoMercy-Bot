...
{
    [JsonProperty("default_sets")] public int[] DefaultSets { get; set; } = [];
    [JsonProperty("sets")] public Dictionary<string, FrankerFacezSet> Sets { get; set; } = new();
    [JsonProperty("users")] public Dictionary<string, string[]> Users { get; set; } = new();
}
...
public class Emoticon
{
    ...
    [JsonProperty("modifier_flags")] public int ModifierFlags { get; set; }
    [JsonProperty("offset")] public object? Offset { get; set; }
    [JsonProperty("margins")] public object? Margins { get; set; }
    [JsonProperty("css")] public object? Css { get; set; }
    [JsonProperty("owner")] public FrankerFacezOwner Owner { get; set; } = new();
    [JsonProperty("artist")] public object? Artist { get; set; }
    [JsonProperty("urls")] public Dictionary<string, Uri> Urls { get; set; } = new();
    [JsonProperty("status")] public int Status { get; set; }
    [JsonProperty("usage_count")] public int UsageCount { get; set; }
