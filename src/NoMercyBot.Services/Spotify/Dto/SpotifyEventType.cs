...
public class SpotifyHeaders
{
	...
	[JsonProperty("Spotify-Connection-Id")] public string? SpotifyConnectionId { get; set; }
}

public abstract class SpotifyGenricEvent<T>
{
	[JsonProperty("headers")] public SpotifyHeaders? Headers { get; set; }
	[JsonProperty("payloads")] public T[]? Payloads { get; set; }
