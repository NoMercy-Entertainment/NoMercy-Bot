...
{
    [JsonProperty("external_urls")] public ExternalUrls ExternalUrls { get; set; } = new();
    [JsonProperty("href")] public Uri Href { get; set; } = null!;
    [JsonProperty("type")] public string Type { get; set; } = null!;
    [JsonProperty("uri")] public string Uri { get; set; } = null!;
}
...
public class Item
{
    ...
    [JsonProperty("artists")] public Artist[] Artists { get; set; } = [];
...
public class Album
{
    [JsonProperty("album_type")] public string AlbumType { get; set; } = null!;
    [JsonProperty("artists")] public Artist[] Artists { get; set; } = [];
    [JsonProperty("available_markets")] public string[] AvailableMarkets { get; set; } = [];
    [JsonProperty("external_urls")] public ExternalUrls ExternalUrls { get; set; } = new();
    [JsonProperty("href")] public Uri Href { get; set; } = null!;
...
{
    [JsonProperty("isrc")] public string Isrc { get; set; } = null!;
}