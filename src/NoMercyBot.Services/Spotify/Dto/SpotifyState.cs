...
public class SpotifyState {
	...
	[JsonProperty("context")] public SpotifyContext? Context { get; set; }
	[JsonProperty("progress_ms")] public int ProgressMs { get; set; }
	[JsonProperty("item")] public SpotifyItem? Item { get; set; }
	[JsonProperty("currently_playing_type")] public string? CurrentlyPlayingType { get; set; }
	[JsonProperty("actions")] public SpotifyActions? Actions { get; set; }
...
public class SpotifyActions {
	[JsonProperty("disallows")] public SpotifyDisallows? Disallows { get; set; }
}

public class SpotifyDisallows {
	[JsonProperty("resuming")] public bool Resuming { get; set; }
	[JsonProperty("toggling_repeat_context")] public bool TogglingRepeatContext { get; set; }
	[JsonProperty("toggling_repeat_track")] public bool TogglingRepeatTrack { get; set; }
	[JsonProperty("toggling_shuffle")] public bool TogglingShuffle { get; set; }
}
...
public class SpotifyDevice {
	...
	[JsonProperty("is_private_session")] public bool IsPrivateSession { get; set; }
	[JsonProperty("is_restricted")] public bool IsRestricted { get; set; }
	[JsonProperty("name")] public string? Name { get; set; }
	[JsonProperty("supports_volume")] public bool SupportsVolume { get; set; }
	[JsonProperty("type")] public string? Type { get; set; }
...
public class SpotifyItem {
	...
	[JsonProperty("artists")] public SpotifyArtist[]? Artists { get; set; }
...
public class SpotifyAlbum {
	...
	[JsonProperty("href")] public string? Href { get; set; }
	[JsonProperty("id")] public string? Id { get; set; }
	[JsonProperty("images")] public SpotifyImage[]? Images { get; set; }
	[JsonProperty("is_playable")] public bool IsPlayable { get; set; }
	[JsonProperty("name")] public string? Name { get; set; }
