...
{
    [JsonProperty("payloads")] public new string[]? Payloads { get; set; }
    [JsonProperty("uri")] public string? Uri { get; set; }
    [JsonProperty("type")] public string? EventType { get; set; }
    [JsonProperty("payload")] public SpotifyLikePayload? Payload { get; set; }
}

public class SpotifyLikePayload
{
    [JsonProperty("items")] public SpotifyLikeItem[]? Items { get; set; }
}

public class SpotifyLikeItem
{
    [JsonProperty("type")] public string? Type { get; set; }
    [JsonProperty("unheard")] public bool Unheard { get; set; }
